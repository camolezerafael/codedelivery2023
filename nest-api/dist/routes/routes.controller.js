...
let RoutesController = class RoutesController {
    ...
    consumeNewPosition(value) {
        this.routeGateway.sendPosition(Object.assign(Object.assign({}, value), { position: [value.position[1], value.position[0]] }));
    }
};
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    (0, microservices_1.MessagePattern)('route.new-position'),
